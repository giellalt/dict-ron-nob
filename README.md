# Dictionary for ron — nob

This repository contains source files for a dictionary from Romanian to Norwegian Bokmål. The content is licensed under the  license.
